...
model.df.time.subsets=data.frame(
 ...
 ggplot(model.df.time.subsets)+geom_density(aes(model.df.time.subsets$sigma1),colour="red")+geom_density(aes(model.df.time.subsets$sigma2),colour="purple")+geom_density(aes(model.df.time.subsets$sigma3),colour="blue")+geom_density(aes(model.df.time.subsets$sigma4),colour="green")+theme_bw()+xlab("Standard Deviation")
 
 ggplot(model.df.time.subsets)+geom_density(aes(model.df.time.subsets$sigma1),colour="red")+geom_density(aes(model.df.time.subsets$sigma2),colour="purple")+geom_density(aes(model.df.time.subsets$sigma3),colour="blue")+geom_density(aes(model.df.time.subsets$sigma4),colour="green")+theme_bw()+xlab("Standard Deviation")+geom_density(aes(stdev),data=data.frame(stdev=stdev))
